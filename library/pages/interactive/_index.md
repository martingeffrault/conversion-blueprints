...
### [Calculator & Tool Pages](./calculator.md)
...
1. **Start with a quiz** if you need volume and segmentation
2. **Start with a calculator** if you need high-intent leads
3. **Build both** for full-funnel coverage

---

## Cross-References

- **Lead generation strategy**: See [Landing Pages](../landing-page/)
- **Form optimization**: See [Form Optimization](../../conversion/form-optimization.md)
- **Micro-conversions**: See [Micro-Conversions](../../conversion/micro-conversions.md)
